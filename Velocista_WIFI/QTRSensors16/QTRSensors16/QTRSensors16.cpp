...
void QTRSensors16::init(unsigned char *pins, unsigned char numSensors,
...
void QTRSensors16::read(unsigned int *sensor_values, unsigned char readMode)
{
...
void QTRSensors16::resetCalibration()
{
    unsigned char i;
    for(i=0;i<_numSensors;i++)
    {
...
void QTRSensors16::calibrate(unsigned char readMode)
{
...
void QTRSensors16::initializeCalibrationVectors (unsigned int **calibratedMinimum, unsigned int **calibratedMaximum){
    int i = 0;
...
void QTRSensors16::calibrateOnOrOff(unsigned int **calibratedMinimum,
...
void QTRSensors16::readCalibrated(unsigned int *sensor_values, unsigned char readMode,int flanco_sens)
{
    int i;
...
int QTRSensors16::readLine(unsigned int *sensor_values,
...
void QTRSensorsRC::init(unsigned char* pins,
    unsigned char numSensors, unsigned int timeout, unsigned char emitterPin)
{
    QTRSensors16::init(pins, numSensors, emitterPin);
...
void QTRSensorsMux::init (unsigned char* pins, unsigned char numSensors, unsigned char numSamplesPerSensor,
                            unsigned char inPin, unsigned char* muxPins)
{
    QTRSensors16::init(pins, numSensors, (unsigned char)255);
    unsigned char i;
    for (i = 0; i < 4; i++)
    {
