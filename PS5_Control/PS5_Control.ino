    ...
    //Derecha
      ...
      if (!(bR2 or bL2)) {
        ...
        if (Turbo) {
          ...
          digitalWrite(MotorC[2], LOW);
          //Motor D
          ledcWrite(Canales[3], 200);
          digitalWrite(MotorD[1], LOW);
          digitalWrite(MotorD[2], HIGH);
          //Impresión
          Serial.println("Derecha Sin Gatillos Turbo");
        }
      }
      ...
      if (bR2) {
        ...
        if (Turbo) {
          ...
          velocidades[0] = (velocidades[0] < 0) ? 0 : velocidades[0];
          velocidades[1] = (velocidades[1] < 0) ? 0 : velocidades[1];
          velocidades[1] = (velocidades[1] > 10 && velocidades[1] < 500) ? velocidades[1] + 500 : (velocidades[1] >= 1000) ? 1000
                                                                                                                           : velocidades[1];
          velocidades[2] = (velocidades[2] < 0) ? 0 : velocidades[2];
          velocidades[2] = (velocidades[2] > 10 && velocidades[2] < 500) ? velocidades[2] + 500 : (velocidades[2] >= 1000) ? 1000
                                                                                                                           : velocidades[2];
          velocidades[3] = (velocidades[3] < 0) ? 0 : velocidades[3];
    ...
    //Izquierda
      ...
      if (!(bR2 or bL2)) {
        ...
        if (Turbo) {
          ...
          digitalWrite(MotorA[2], LOW);
          //Motor B
          ledcWrite(Canales[1], 200);
          digitalWrite(MotorB[1], LOW);
          digitalWrite(MotorB[2], HIGH);
          //Motor C
          ledcWrite(Canales[2], 200);
          digitalWrite(MotorC[1], LOW);
          digitalWrite(MotorC[2], HIGH);
          //Motor D
          ...
          digitalWrite(MotorD[2], LOW);
          //Impresión
          Serial.println("Izquierda Sin Gatillos Turbo");
        }
      }
      //Adelante
      ...
      if (bR2) {
        ...
        if (Turbo) {
          ...
          //Limitaciones de los Motores
          velocidades[0] = (velocidades[0] < 0) ? 0 : velocidades[0];
          velocidades[0] = (velocidades[0] > 10 && velocidades[0] < 500) ? velocidades[0] + 500 : (velocidades[0] >= 1000) ? 1000
                                                                                                                           : velocidades[0];
          velocidades[1] = (velocidades[1] < 0) ? 0 : velocidades[1];
          velocidades[2] = (velocidades[2] < 0) ? 0 : velocidades[2];
          velocidades[3] = (velocidades[3] < 0) ? 0 : velocidades[3];
          velocidades[3] = (velocidades[3] > 10 && velocidades[3] < 500) ? velocidades[3] + 500 : (velocidades[3] >= 1000) ? 1000
                                                                                                                           : velocidades[3];
